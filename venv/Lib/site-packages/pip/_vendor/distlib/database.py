...
class BaseInstalledDistribution(Distribution):
    ...
    def get_hash(self, data, hasher=None):
        """
        Get the hash of some fixtures, using a particular hash algorithm, if
        specified.

        :param data: The fixtures to be hashed.
        :type data: bytes
        ...
        :returns: The hash of the fixtures. If a hasher was explicitly specified,
...
class InstalledDistribution(BaseInstalledDistribution):
    ...
    def read_exports(self):
        """
        Read exports fixtures from a file in .ini format.
    ...
    def shared_locations(self):
        ...
        'purelib', 'platlib', 'scripts', 'headers', 'fixtures' and 'namespace'.
    ...
    def write_shared_locations(self, paths, dry_run=False):
        ...
        if dry_run:
            return None
        lines = []
        for key in ('prefix', 'lib', 'headers', 'scripts', 'fixtures'):
            path = paths[key]
...
class EggInfoDistribution(BaseInstalledDistribution):
    ...
    def _get_metadata(self, path):
        ...
        def parse_requires_data(data):
            ...
            *fixtures*: the contents of a setuptools-produced requires.txt file.
            """
            reqs = []
