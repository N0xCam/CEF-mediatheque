...
def _install_wheel(  # noqa: C901, PLR0915 function is too long
    ...
    def data_scheme_file_maker(
        ...
        def make_data_scheme_file(record_path: RecordPath) -> "File":
            ...
            try:
                ...
                message = (
                    f"Unexpected file in {wheel_path}: {record_path!r}. .fixtures directory"
            ...
            try:
                ...
                message = (
                    ...
                    f"(for file {record_path!r}). .fixtures directory contents "
    ...
    def is_data_scheme_path(path: RecordPath) -> bool:
        return path.split("/", 1)[0].endswith(".fixtures")
    ...
    def is_script_scheme_path(path: RecordPath) -> bool:
        parts = path.split("/", 2)
        return len(parts) > 2 and parts[0].endswith(".fixtures") and parts[1] == "scripts"
    ...
    def pyc_source_file_paths() -> Generator[str, None, None]:
        ...
        # file in .fixtures maps to same location as file in wheel root).
